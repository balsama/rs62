 ...
 * @endcode
 */
$settings['hash_salt'] = '_VyVGp5yaupwmf-BpXwqH03PQdC5dmlOaW3dFvi_L368FyRB9oWhuUYT0k75F8ZGUoCdJKHINg';
...
if (file_exists('/var/www/vhosts/settings/rs62-settings.inc')) {
  include '/var/www/vhosts/settings/rs62-settings.inc';
}
